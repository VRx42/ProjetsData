...
h_x = sigmoid(Z3); % m x num_labels == 5000 x 10
...
J = J + reg_term;
  ...
  Theta1_grad_reg_term = (lambda/m) * [zeros(size(Theta1, 1), 1) Theta1(:,2:end)]; % 25 x 401, on ajoute une colonne de 0, qui est utilisée par le biais term
  ...
  Theta1_grad = Theta1_grad + Theta1_grad_reg_term; %les deux font la meme taille 25 x 401
  Theta2_grad = Theta2_grad + Theta2_grad_reg_term; %10 x 26
